...
הפריסה ב־Vercel משתמשת באותו מסד D1 דרך API מאובטח מצד השרת. כך הנתונים הקיימים נשארים במקום אחד ואין צורך להעתיק אותם. אסימון Cloudflare לעולם אינו נשלח לדפדפן.
