...
type Item = { id: number | string; kind: string; settlementIssue?:"rule"|"manual"|"date"; donorCardId: number | null; paymentMethod?: string; title: string; detail: string; priority: string; dueDate: string | null; status: string };
